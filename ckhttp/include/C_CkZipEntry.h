...
BOOL CkZipEntry_Copy(HCkZipEntry cHandle, HCkByteData bdata);
BOOL CkZipEntry_CopyToBase64(HCkZipEntry cHandle, HCkString str);
BOOL CkZipEntry_CopyToHex(HCkZipEntry cHandle, HCkString str);
...
BOOL CkZipEntry_Inflate(HCkZipEntry cHandle, HCkByteData bdata);
BOOL CkZipEntry_InflateToString(HCkZipEntry cHandle, BOOL addCR, HCkString str);
BOOL CkZipEntry_InflateToString2(HCkZipEntry cHandle, HCkString str);
