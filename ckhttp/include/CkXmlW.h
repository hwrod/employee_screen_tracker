...
class CkXmlW : public CkXml
{
	...
	bool setBinaryContent2W(const unsigned char *data,unsigned long dataLen,bool zipFlag,bool encryptFlag,const wchar_t *w1)
		{
		CkString sTemp1; sTemp1.appendU(w1);
		return this->SetBinaryContent2(data,dataLen,zipFlag,encryptFlag,sTemp1.getUtf8());
		}
