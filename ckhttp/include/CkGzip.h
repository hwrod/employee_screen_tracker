...
public:
	...
	void DeflateStringENC(const char *str, const char *charset, const char *encoding, CkString &outStr);
	void InflateStringENC(const char *str, const char *charset, const char *encoding, CkString &outStr);
