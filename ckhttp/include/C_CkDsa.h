...
BOOL CkDsa_FromDerFile(HCkDsa cHandle, const char *filename);
...
BOOL CkDsa_FromPublicDerFile(HCkDsa cHandle, const char *filename);
...
BOOL CkDsa_GenKeyFromParamsDerFile(HCkDsa cHandle, const char *filename);
BOOL CkDsa_GenKeyFromParamsPem(HCkDsa cHandle, const char *pem);
BOOL CkDsa_GenKeyFromParamsPemFile(HCkDsa cHandle, const char *filename);
...
BOOL CkDsa_LoadText(HCkDsa cHandle, const char *filename, HCkString outStr);
BOOL CkDsa_SaveLastError(HCkDsa cHandle, const char *filename);
BOOL CkDsa_SaveText(HCkDsa cHandle, const char *strToSave, const char *filename);
...
BOOL CkDsa_ToDerFile(HCkDsa cHandle, const char *filename);
...
BOOL CkDsa_ToPublicDerFile(HCkDsa cHandle, const char *filename);
...
const char *CkDsa_loadText(HCkDsa cHandle, const char *filename);
