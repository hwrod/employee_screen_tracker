...
void CkSpider_CanonicalizeUrl(HCkSpider cHandle, const char *url, HCkString urlOut);
...
BOOL CkSpider_FetchRobotsText(HCkSpider cHandle, HCkString strOut);
BOOL CkSpider_GetAvoidPattern(HCkSpider cHandle, long index, HCkString strOut);
void CkSpider_GetBaseDomain(HCkSpider cHandle, const char *domain, HCkString domainOut);
BOOL CkSpider_GetFailedUrl(HCkSpider cHandle, long index, HCkString strOut);
BOOL CkSpider_GetOutboundLink(HCkSpider cHandle, long index, HCkString strOut);
BOOL CkSpider_GetSpideredUrl(HCkSpider cHandle, long index, HCkString strOut);
BOOL CkSpider_GetUnspideredUrl(HCkSpider cHandle, long index, HCkString strOut);
void CkSpider_GetUrlDomain(HCkSpider cHandle, const char *url, HCkString domainOut);
void CkSpider_Initialize(HCkSpider cHandle, const char *domain);
BOOL CkSpider_RecrawlLast(HCkSpider cHandle);
BOOL CkSpider_SaveLastError(HCkSpider cHandle, const char *filename);
