...
class CkSpider  : public CkObject
{
	...
	void GetUrlDomain(const char *url, CkString &outStr);
	void GetBaseDomain(const char *domain, CkString &outStr);
	void CanonicalizeUrl(const char *url, CkString &outStr);
